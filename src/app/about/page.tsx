    ...
    <div className="container mx-auto py-12 px-4 space-y-12">
      ...
      <section className="grid md:grid-cols-2 gap-8 items-center">
        <div>
          ...
          <p className="text-foreground mb-4 leading-relaxed">
            Café Regional nació del amor por el café y el profundo respeto por las tradiciones cafeteras de Colombia. Fundada en [Año de Fundación Placeholder], comenzamos nuestro viaje con la misión de destacar la calidad única de los cafés de origen de regiones emblemáticas como Ragonvalia, Arboledas y Durania.
          </p>
      ...
      <section>
        ...
        <p className="text-foreground text-center max-w-3xl mx-auto mb-6 leading-relaxed">
          En Café Regional, nuestro lazo con las regiones cafeteras va más allá del comercio. Buscamos construir relaciones a largo plazo basadas en la confianza, el respeto y el beneficio mutuo.
        </p>
